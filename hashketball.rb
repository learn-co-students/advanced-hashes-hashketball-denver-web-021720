...
def num_points_scored(find_player_name)
  game_hash.each do |_palce, team|
    team.each do |attribute, data|
      next unless attribute == :players
      data.each do |player|
        return player[:points] if player[:player_name] == find_player_name
      end
    end
  end
end
...
def shoe_size(find_player_name)
  game_hash.each do |_place, team|
    team.each do |attribute, data|
      next unless attribute == :players
      data.each do |player|
        return player[:shoe] if player[:player_name] == find_player_name
      end
    end
  end
end
...
def team_colors(team_name)
  game_hash.each do |place, team|
    returmn game_hash[place][:colors] if team[:team_name] == team_name
  end
end
